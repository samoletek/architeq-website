  ...
  return (
    <SiteLayout>
      ...
      {!isMobile && (
        ...
        >
          {/* Заголовки */}
          <div className="absolute left-0 right-0 z-10 text-center px-4" style={{ top: 'clamp(8rem, 12vw, 18rem)' }}>
          ...
          <div className="sticky top-0 h-screen overflow-hidden">
            <div className="absolute inset-0 pb-16" style={{ paddingTop: 'clamp(14rem, 18vw, 24rem)' }}>
