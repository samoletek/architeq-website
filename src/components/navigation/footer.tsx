          ...
          <div className="space-y-6 text-left lg:text-right">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4 justify-start lg:justify-end relative">
                {/* LinkedIn (активный) */}
                <a 
                  href="https://www.linkedin.com/in/drewsergienko/"
                  target="_blank"
                ...
                {showSocialTooltip && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="absolute bottom-full mb-2 right-0 bg-dark-gray border border-medium-gray rounded-lg px-4 py-2 text-sm text-light-gray whitespace-nowrap shadow-lg"
                  >
